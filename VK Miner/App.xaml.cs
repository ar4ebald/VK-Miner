...
namespace VK_Miner
{
    ...
    sealed partial class App : Application
    {
        ...
        delegate VK.RequestData CreatorDelegate(long ownerId, int count);

        private static CreatorDelegate Creator = VK.RequestData.Creator<CreatorDelegate>("photos.getAll",
            new VK.RequestArgs()
            {
                ["extended"] = 1,
                ["photo_sizes"] = 1
